...
"%convert%" %file%.icon.png -distort ScaleRotateTranslate 5 %file%.2.icon.png
"%convert%" %file%.icon.png -distort ScaleRotateTranslate 10 %file%.3.icon.png
"%convert%" %file%.icon.png -distort ScaleRotateTranslate 15 %file%.4.icon.png
"%convert%" %file%.icon.png -distort ScaleRotateTranslate 20 %file%.5.icon.png
